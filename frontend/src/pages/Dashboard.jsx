                ...
                <Box sx={{ mb: 4 }}>
                  ...
                  <Grid container spacing={2}>
                    {separateTasks().completed.map((task) => (
                      <Grid item xs={6} sm={6} md={4} lg={3} key={task._id}>
                        <Card
                          sx={{
                            height: '100%',
                            display: 'flex',
      ...
      >
        {filteredTasks.map((task) => (
          <Todo
            ...
            onTimeUpdate={(taskId, newTime) => handleTimeUpdate(taskId, newTime)}
            onStatusChange={(taskId, completed) => handleTaskCompletion(taskId)}
            onShare={(task) => handleMenuClick(task)}
          />
        ))}
      </Box>
    </Box>
